...
<div class="tab">
  <button class="tablinks" onclick="openTab(event, 'levA')">Funciones</button>
  <button class="tablinks" onclick="openTab(event, 'levB')">Gráfico</button>
</div>
...
**Valor Esperado Limitado Funciones**
...
<h3>Gráfico ilustrativo</h3>

**Comparación del valor esperado limitado para una selección de distribuciones**
...
X=1:1000
plot(x=X,y=levpareto(X,3,200),col="red",type="l",xlab="x values", 
     ylab="Valor Esperado Limitado",main="Limted Expected Values for Several Distributions")
...
legend("bottomright",legend=c("Pareto","Exponencial","Gamma","Weibull","GB2"),lty=c(1,1,1,1,1),col=c("red","blue","green","orange","purple"))
```
